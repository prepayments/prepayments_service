...
/**
 * A DTO for the AmortizationEntry entity.
 */
public class AmortizationEntryDTO implements Serializable {
    ...
    public String toString() {
        return "AmortizationEntryDTO{" + "id=" + getId() + ", amortizationDate='" + getAmortizationDate() + "'" + ", amortizationAmount=" + getAmortizationAmount() + ", particulars='" +
            getParticulars() + "'" + ", posted='" + isPosted() + "'" + ", serviceOutlet='" + getServiceOutlet() + "'" + ", accountNumber='" + getAccountNumber() + "'" + ", accountName='" +
            getAccountName() + "'" + ", prepaymentEntry=" + getPrepaymentEntryId() + "}";
    }
}
