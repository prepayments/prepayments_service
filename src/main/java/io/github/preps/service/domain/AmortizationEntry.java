...
@Document(indexName = "amortizationentry")
public class AmortizationEntry implements Serializable {
    ...
    @NotNull
    @Column(name = "amortization_amount", precision = 10, scale = 2, nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        AmortizationEntry amortizationEntry = (AmortizationEntry) o;
        if (amortizationEntry.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), amortizationEntry.getId());
    }
