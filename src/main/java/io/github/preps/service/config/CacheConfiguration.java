package io.github.preps.service.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("prepaymentsservice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("prepaymentsservice");
        ...
        config.getMapConfigs().put("io.github.preps.service.domain.*", initializeDomainMapConfig(jHipsterProperties));
