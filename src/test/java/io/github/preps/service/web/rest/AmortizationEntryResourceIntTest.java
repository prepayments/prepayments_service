...
import io.github.preps.service.config.SecurityBeanOverrideConfiguration;
...
import io.github.preps.service.web.rest.errors.ExceptionTranslator;
...
import static io.github.preps.service.web.rest.TestUtil.createFormattingConversionService;
...
/**
 * Test class for the AmortizationEntryResource REST controller.
 *
 * @see AmortizationEntryResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, PrepaymentsserviceApp.class})
public class AmortizationEntryResourceIntTest {
    ...
    private static final String DEFAULT_SERVICE_OUTLET = "120";
    private static final String UPDATED_SERVICE_OUTLET = "724";

    private static final String DEFAULT_ACCOUNT_NUMBER = "97606108612";
    private static final String UPDATED_ACCOUNT_NUMBER = "70792353661";
    ...
    /**
     * This repository is mocked in the io.github.preps.service.repository.search test package.
     *
     * @see io.github.preps.service.repository.search.AmortizationEntrySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static AmortizationEntry createEntity(EntityManager em) {
        AmortizationEntry amortizationEntry = new AmortizationEntry().amortizationDate(DEFAULT_AMORTIZATION_DATE)
        ...
        // Add required entity
        PrepaymentEntry prepaymentEntry = PrepaymentEntryResourceIntTest.createEntity(em);
    ...
    public void createAmortizationEntry() throws Exception {
        ...
        restAmortizationEntryMockMvc.perform(post("/api/amortization-entries").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(amortizationEntryDTO)))
    ...
    public void getNonExistingAmortizationEntry() throws Exception {
        // Get the amortizationEntry
        restAmortizationEntryMockMvc.perform(get("/api/amortization-entries/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    public void updateAmortizationEntry() throws Exception {
        ...
        updatedAmortizationEntry.amortizationDate(UPDATED_AMORTIZATION_DATE)
        ...
        restAmortizationEntryMockMvc.perform(put("/api/amortization-entries").contentType(TestUtil.APPLICATION_JSON_UTF8).content(TestUtil.convertObjectToJsonBytes(amortizationEntryDTO)))
                                    .andExpect(status().isOk());
    ...
    public void deleteAmortizationEntry() throws Exception {
        ...
        restAmortizationEntryMockMvc.perform(delete("/api/amortization-entries/{id}", amortizationEntry.getId()).accept(TestUtil.APPLICATION_JSON_UTF8)).andExpect(status().isOk());
    ...
    public void searchAmortizationEntry() throws Exception {
        // Initialize the database
        amortizationEntryRepository.saveAndFlush(amortizationEntry);
        when(mockAmortizationEntrySearchRepository.search(queryStringQuery("id:" + amortizationEntry.getId()), PageRequest.of(0, 20))).thenReturn(
            new PageImpl<>(Collections.singletonList(amortizationEntry), PageRequest.of(0, 1), 1));
