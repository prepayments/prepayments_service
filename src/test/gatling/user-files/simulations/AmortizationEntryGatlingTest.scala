...
class AmortizationEntryGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the AmortizationEntry entity")
        ...
        .repeat(2) {
            ...
            .get("/prepaymentsservice/api/amortization-entries")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new amortizationEntry")
            .post("/prepaymentsservice/api/amortization-entries")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/prepaymentsservice${new_amortizationEntry_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created amortizationEntry")
            .delete("/prepaymentsservice${new_amortizationEntry_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
